...
// функция для того чтобы узнать ip (навигатор, чтобы другие устройства могли найти эту сеть)
const getLocalIp = () => {
    // объект массивов 
    ...
    for (const name of Object.keys(interfaces)) {
        ...
        // еще один цикл, чтобы могли достать адрес
...
// 0.0.0.0 чтобы могли подключиться другие устройства (внутри wifi)
